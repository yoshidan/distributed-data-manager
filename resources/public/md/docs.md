...
Two middleware functions are provided by default in the `data-rebalancer.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `data-rebalancer.handler` namespace to manage the enabled middleware.
